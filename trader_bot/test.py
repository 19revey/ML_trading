...
if __name__ == "__main__":
    ...
    # data_ingestion=DataIngestion(start='2024-05-01',end='2024-08-01',interval = '1Day',ticker_list = ticker_list)
    # data=data_ingestion.initiate(train=True)

    # data_ingestion=DataIngestion(start='2024-08-01',end='2024-09-01',interval = '1Day',ticker_list = ticker_list)
